...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "LINEヤフー広告 ConversionAPIタグ",
  "brand": {
    "id": "brand_dummy",
    "displayName": "",
  ...
  "description": "LINEヤフー広告のConversionAPI用タグです。  \n※設定について注意点があります。「リンク」の「ドキュメント」をクリックしてご確認ください。  \nLINE Conversion APIのパラメータも利用可能な、より精度の高い新しいコンバージョンAPIも提供しております。新規で導入する場合は、新しいコンバージョンAPIのご利用をおすすめします。",
  "categories": [
    "ADVERTISING",
    "MARKETING",
    "CONVERSIONS"
...
[
  {
    "type": "LABEL",
    "name": "notice2",
    "displayName": "\u003cstrong\u003e\nLINE Conversion APIのパラメータも利用可能な、より精度の高い新しいコンバージョンAPIも提供しております。新規で導入する場合は、新しいコンバージョンAPIのご利用をおすすめします。\u003cbr\u003e\nなお、本ドキュメントにある従来版コンバージョンAPIも引き続きご利用可能ですが、今後提供終了を予定しております。提供終了時期については決まり次第お知らせいたします。\u003cbr\u003e\n新しいコンバージョンAPIのドキュメントはこちら: \u003ca href\u003d\"https://ads-developers.yahoo.co.jp/ja/conversion-api/\"\u003ehttps://ads-developers.yahoo.co.jp/ja/conversion-api/\u003c/a\u003e\n\u003cbr\u003e\u003cbr\u003e\nWe also offer a new, more accurate Conversion API that supports the parameters of the LINE Conversion API. If you are implementing it for the first time, we recommend using the new Conversion API.\u003cbr\u003e\nThe legacy Conversion API described in this document will continue to be available. However, it is scheduled to be discontinued in the future. We will announce the end-of-service date once it has been decided.\u003cbr\u003e\nDocumentation for the new Conversion API: \u003ca href\u003d\"https://ads-developers.yahoo.co.jp/en/conversion-api/\"\u003ehttps://ads-developers.yahoo.co.jp/en/conversion-api/\u003c/a\u003e\n\u003cbr\u003e\u003cbr\u003e\n\u003c/strong\u003e"
  },
  {
    "type": "LABEL",
    "name": "notice",
  ...
  },
  {
    ...
    "displayName": "ifa",
    "simpleValueType": true,
    "help": "IDFAもしくはAAID。IDFAは大文字、AAIDは小文字で入力してください。"
  },
  {
    "type": "TEXT",
    "name": "event_time",
    ...
    "help": "コンバージョンの発生日時。リクエスト日時より90日前〜現在時刻の間の10桁UNIX時間で入力してください。13桁UNIX時間が入力された場合は下三桁を無視して10桁UNIX時間として扱います。現在時刻付近のリクエストはAPIで補正される場合があります。"
  },
  {
    "type": "TEXT",
  ...
  },
  {
    ...
    "simpleValueType": true,
    "help": "コンバージョンしたユーザーのブラウザのユーザーエージェント。"
  },
  {
    "type": "TEXT",
    "name": "yjsu_yjad",
    "displayName": "yjsu_yjad",
    "simpleValueType": true,
    "help": "ウェブサイトドメイン内のユニーク識別情報。Cookie `_yjsu_yjad` の値を入力してください。"
  },
  {
    "type": "TEXT",
    "name": "url",
...
function buildRequestBody() {
  ...
  body.ip = data.ip || getEventData('ip_override');
  body.user_agent = data.user_agent || getEventData('user_agent');
  body.yjsu_yjad = data.yjsu_yjad || getCookieValues('_yjsu_yjad')[0];
  body.url = data.url || getEventData('page_location');
  body.referrer = data.referrer || getEventData('page_referrer');
  body._s = 'ssgtm';
  return body;
}
